	...
	<>
		<div class="container mb-32 md:mb-4">
			<div class="bg-white p-6 rounded-lg shadow-lg max-w-2xl w-full">
				...
				<div class="mt-6">
					<h3 class="font-bold">1- Directors Circle Commitment</h3>
					<p class="text-gray-700 text-sm">As we did last year for the Great Give we are seeking pledges to create a directors circle match. Make a donation to help us meet matching challenges and inspire others. Payment due by April 15</p>
				...
				<div class="mt-6">
					<h3 class="font-bold">2- Your Impact in Action</h3>
					...
					<p class="mt-4 font-semibold">💙 Your Impact in Action Commitment</p>
					<div class="mt-2">
				...
				<div class="mt-6">
					<h3 class="font-bold">3- Pub Sing</h3>
