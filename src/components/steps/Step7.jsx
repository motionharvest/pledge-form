	...
	<>
		<div class="container mb-32 md:mb-4 bg-white p-6 rounded-lg shadow-lg max-w-2xl w-full">
			<h2 class="text-xl font-semibold">
				...
				<span class="text-gray-700 text-sm">(Deadline to join the effort: March 31; sponsor deadline May 1)</span>
			</h2>
		...
		<div class="control-ui shadow-lg flex justify-center gap-4 mt-2 mb-2">
			<button onClick={() => props.setStep(6)} class="w-full bg-gray-600 hover:bg-gray-700 text-white py-2 rounded-lg text-sm font-medium transition">Back</button>

			<button onClick={() => props.setStep(8)} class="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-2 rounded-lg text-sm font-medium transition">Next: Summary</button>
		</div>
	</>
)